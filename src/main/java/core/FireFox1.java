...
//	static String password = System.getenv("fb_password");
	...
	public static void main(String[] cla) throws InterruptedException, FileNotFoundException, IOException {
		...
		System.out.println("----- Start of Test: HW_40_QA1 - FireFox1 ---------");
...
//		System.out.println("Test Strated: " + timeStampST);
		p.getProperty("startTimeStamp");
		p.getProperty("printStartTimeStamp");
		Thread.sleep(2000);
...
//		System.out.println("Test Ended: " + timeStamp);
        p.getProperty("endTimeStamp");
		p.getProperty("printEndTimeStamp");
